...
REQUIRED_STATUS_PATHS = frozenset(
    {
        ...
        "cflow/intellec-mod40-evidence-gate-statuses.status",
        ...
        "cflow/intellec-mod40-terminal_electrical_timing_is_traced.status",
        "cflow/intellec-mod40-monitor_socket_map_is_traced.status",
        "cflow/intellec-mod40-monitor_data_transform_is_primary_backed.status",
        "cflow/intellec-mod40-accepted_monitor_read_set_count.status",
        "cflow/virtual-fpga-system.status",
        "cflow/gate-export-python.status",
        "cflow/netlist-publish-python.status",
        "cflow/mod40-evidence-python.status",
        "cscope/build.status",
        "cscope/cpp.status",
        "cscope/gate-export-python.status",
        "cscope/mod40-evidence-python.status",
        ...
        "python/mod40-evidence-callgraph.status",
