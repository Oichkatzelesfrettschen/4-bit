...
pub use mod40_routes::{
    ...
    program_ram_card_edge_is_complete, ram0_port_value_drives_printer_marking_current, ram1_port_value_enables_reader,
    terminal_cable_routes_are_traced, terminal_current_loop_polarity_is_traced, CpuClockResetRoute,
    CpuClockTimingTarget, CpuStopAcknowledgeEndpoint, Imm628WriteReadInput, Mod40RouteEvidence, Mod40TerminalPolarity,
    MonitorAddressFanout, MonitorSelectDecodeInput, MonitorSelectDecodeOutput, PanelControlObservation,
    ProgramRamCardEdgeRoute, StopAcknowledgeObservation, TerminalCableRoute, TerminalPortPolarity,
