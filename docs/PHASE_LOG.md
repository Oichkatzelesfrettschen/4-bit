...
| 2 | 4040 CPU execution | COMPLETE | `docs/PHASE_2_STATUS.md`, `docs/PHASE_2_DEBUG_NOTES.md`, `PHASE_2_CHECKPOINT.md` (root, snapshot-disclaimed) |
| 3 | Support chips and GUI | COMPLETE | `docs/PHASE_3_STATUS.md` (cosmic-stream forward-plan section redacted 2026-04-30) |
...
| 6 | Gate extraction, subcircuit bridges, full-chip circuit sims | COMPLETE | session log entries in `mcs4-emu/STATUS.md`; planning context in `NEXT_STEPS.md` and `SCOPING_ASSESSMENT.md` (snapshot-disclaimed) |
