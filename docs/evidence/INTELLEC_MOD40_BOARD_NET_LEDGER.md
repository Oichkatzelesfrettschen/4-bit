...
| direct | PDF 13, drawing 2000329 | Front-panel J2 contact 9 receives `STOP ACK` and enters an A29 7417 display-driver path. | This establishes the panel-local receiver path. The source connector mapping, display state equation, and asserted polarity remain open. |
